...
// Pricing page — PricingCard + FAQ + trust signals
// ═══════════════════════════════════════════════════════════════════════════
...
const PRICING_FAQ = [
  ...
  },
  {
    ...
    a: "Absolutely. Premium is a monthly subscription with no lock-in. Cancel from your account settings at any time.",
  },
  {
...
export default function PricingPage() {
  const pricingSchema = {
    ...
    mainEntity: {
      ...
      description: "Ad-free membership with priority access to 90+ developer tools",
      offers: [
        {
          "@type": "Offer",
          name: "Free",
